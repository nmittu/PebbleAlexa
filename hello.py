...
def home(strToConv):
	...
	temp = speech_to_text.recognize(tf, content_type="audio/L16; rate=16000; channels=1", timestamps=False, word_confidence=False, continuous=True, inactivity_timeout=-1)["results"][0]["alternatives"][0]["transcript"]
	tf.close()
	return temp
