...
def home(strToConv):
	...
	temp = speech_to_text.recognize(tf, content_type="audio/L16; rate=16000; channels=1", timestamps=False, word_confidence=False)["results"][0]["alternatives"]["transcript"]
	tf.close()
	return temp
